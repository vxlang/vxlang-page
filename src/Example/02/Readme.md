...
1. verify the JSON settings.
   - [VxLang](https://github.com/vxlang/vxlang-page/tree/main/vxlang)
   - [JSON](https://github.com/vxlang/vxlang-page/blob/main/vxlang/mapobf64.json)
   - [Bat](https://github.com/vxlang/vxlang-page/blob/main/vxlang/mapobf.bat)
3. Build sample 02.
4. Perform a behavior test.
...
```
	"obfuscator": {
		...
		"obfuscation": [
			...
			"?filt$0@?0??SEHFla@@YAXXZ@4HA",
			"?filt$0@?0??SEHObf@@YAXXZ@4HA",
			"?filt$0@?0??__scrt_common_main_seh@@YAHXZ@4HA",
