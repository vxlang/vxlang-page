...
#define VXLANG_LINK_EVENT_CHECK_DEBUG              0xA000000D

#define VXLANG_LINK_EVENT_CUSTOM_0                 0xB0000000
...
#define VL_CHKDBG()                        (bool)VxLinkEvent(VXLANG_LINK_EVENT_CHECK_DEBUG, nullptr, nullptr)
#else
